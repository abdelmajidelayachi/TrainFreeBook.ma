  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-white" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush my-3">
        ...
        <a href="<?php url('admin/clients') ?>" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i class="fas fa-users me-2"></i>Clients</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row my-5">
          <h3 class="fs-4 mb-3">Our clients</h3>
              ...
              <tbody>
                ...
                foreach ($clients as $client) : ?>
                  <tr>
                    ...
                    <td><?= $client['email'] ?></td>
                    <td><button type="button" class="btn btn-danger"><a href="<?php url('admin/deleteClient/' . $client['clientId']) ?>" style='text-decoration;color:#FFF;'>
