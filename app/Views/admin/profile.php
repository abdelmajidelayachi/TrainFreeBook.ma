        ...
        <div class="container rounded bg-white mt-3">
          <div class="row">
            <div class="col-md-4 border-right">
              <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" src="../uploads/<?= $_SESSION['profileAd']?>" width="90"><span class="font-weight-bold"><?= $_SESSION['AdminName']; ?></span><span class="text-black-50"><?= $_SESSION['email']; ?></span><span>Morocco</span></div>
            </div>
            <div class="col-md-8">
              <div class="p-3 py-5">
              <form action="<?php url('admin/editProfile'); ?>" method="post" enctype="multipart/form-data">
