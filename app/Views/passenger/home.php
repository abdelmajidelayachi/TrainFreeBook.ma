    ...
    <div class="container mt-5 rounded" id="form-search">
      <div class="row">
        <div class="col-lg-6 col-xs-10 p-4" id="form">
          <form action="<?php url('passenger/searchTrip'); ?> " method="POST">
        ...
        <tr>
          ...
          <td>
            <div class="d-grid gap-2 col-8 mx-auto text-nowrap">
              <button class="btn btn-primary" name="book" type="button"><a href="<?php url('passenger/bookingT/'.$travel['travelId']); ?>" style="text-decoration:none;color:white;" > BOOK NOW</a></button>
            </div>
          </td>
        </tr>
